      ...
      <RevealOnScroll>
        <div className="max-w-2xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            {/* Muse Sketch Studio - Cursor for Fashion Designers */}
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              <h3 className="text-xl font-bold mb-2">Muse Sketch Studio - Cursor for Fashion Designers</h3>
              <p className="text-gray-400 mb-4">
                An AI-powered fashion design pipeline that transforms text prompts into complete runway presentations. Features a 5-step workflow: sketch generation, color application, model photography, 3D visualization, and runway video creation.
              </p>
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {["React", "TypeScript", "Node.js", "Google AI", "Replicate API", "Fashion Design", "AI Pipeline"].map(
                  (tech, key) => (
                    <span
                      key={key}
                      className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[0_2px_8px_rgba(59,130,246,0.1)] transition-all"
              ...
              <div className="flex justify-between items-center">
                <a
                  href="https://github.com/Silin144/muse-sketch-studio"
              ...
              <div className="text-xs text-gray-400/80 italic mt-2">
                🏆 1st place at 🚀AI Hackathon: Make Impacts with Replicate • Designed for fashion students, indie designers, and anyone looking to visualize fashion concepts professionally.
              </div>
            </div>
